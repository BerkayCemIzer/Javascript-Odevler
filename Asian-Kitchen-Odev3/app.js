...
function createBTN (btnName) {
  let buttonB = `<button class="btn-item btn btn-outline-secondary" id="${btnName}">${btnName}</button>`
  return buttonB;
}
...
function buttonName () {
  btnContainer.innerHTML = `
    ...
    ${createBTN("China")}
    `
    document.querySelector("#All").addEventListener("click", allF);
...
function allF () {
  let menuAll = "";
  menu.map(menu => {
    menuAll += newFood(menu)
  })
  sectionCenter.innerHTML = menuAll;
}
